  ...
  <div className="uk-background-primary uk-padding-large uk-text-center">
    ...
    <form className="uk-grid-small uk-text-small uk-margin-top" data-uk-grid>
      ...
      <div className="uk-width-1-1@s">
        <textarea className="uk-textarea" rows="4" placeholder="Message" />
        <button type="button" className="uk-button uk-button-alternate uk-text-center uk-align-center uk-width-1-2">Submit</button>
      </div>
